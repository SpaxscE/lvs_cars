...
function ENT:OnSpawn( PObj )
	...
	local DoorHandler = self:AddDoorHandler( Vector(-10,32,24), Angle(0,0,0), Vector(-20,-30,-12), Vector(20,6,12), "left_door" )
	...
	local DoorHandler = self:AddDoorHandler( Vector(-10,-32,24), Angle(0,0,0), Vector(-20,-6,-12), Vector(20,30,12), "right_door" )
	DoorHandler:SetSoundOpen( "lvs/vehicles/generic/Open Door Exterior 01.wav" )
	DoorHandler:SetSoundClose( "lvs/vehicles/generic/Close Door Exterior 01.wav" )
